...
def charger_donnees():
    if os.path.exists(EXCEL_FILE):
        try:
            ...
            # Vérification de sécurité pour les nouvelles colonnes
...
if not df_global.empty:
    ...
    with c_right:
        st.plotly_chart(px.pie(df_filt, values="Quantity", names="Failures", title="Types de Défauts"), use_container_width=True)
